...
namespace GameTemplate
{
    class ScreenControl
    {
        ...
        public static int controlWidth = 560;
        public static int controlHeight = 650;
        ...
        // button values
        public static Size buttonSize = new Size(180, 30);
        public static Color buttonBackColor = Color.White;
        public static Color buttonActiveColor = Color.Cyan;
